        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry" data-aos="fade-up">
              ...
              <div class="entry-content">
                <p>
                  ...
                  <br>(2) women who belong to other savings group; and 
                  <br>(3) women do not belong to any savings group.<br>
                ...
                <!--<div class="read-more">
                  <a href="empowering-vulnerable-women-in-eastern-african-through-innovative-savings-groups.php">Read More</a>
                </div>-->
              </div>
            ...
            <article class="entry" data-aos="fade-up">
              ...
              <h2 class="entry-title">
                <a >An impact evaluation of the Uganda Women Economic Empowerment Program (UWEP)</a>
              </h2>

              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="icofont-user"></i>Fred Matovu, PhD</li>
                  <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <time datetime="2020-01-01">Jan – May 2020</time></li>
                  <li class="d-flex align-items-center"><i class="icofont-comment"></i>Uganda</li>
                </ul>
              </div>
            ...
            <article class="entry" data-aos="fade-up">
              ...
              <h2 class="entry-title">
                <a>Regulatory Impact Assessment (RIA) for Mulago National Specialized Hospital</a>
              </h2>

              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="icofont-user"></i> PADRI Associates Research Team</li>
                  <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <time datetime="2020-01-01">May – July 2017</time></li>
                  <li class="d-flex align-items-center"><i class="icofont-comment"></i>Mulago National Specialized Hospital, Uganda</li>
                </ul>
              </div>
            ...
            <article class="entry" data-aos="fade-up">
              ...
              <h2 class="entry-title">
                <a>The Uganda Cost of Living with Disability Survey (UCLDS)</a>
              </h2>

              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="icofont-user"></i> PADRI in partnership with Development Pathways</li>
                  <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i><time datetime="2020-01-01">2019</time></li>
                  <li class="d-flex align-items-center"><i class="icofont-comment"></i>Uganda</li>
                </ul>
              </div>
            ...
            <article class="entry" data-aos="fade-up">
              ...
              <h2 class="entry-title">
                <a>A scoping study for Refugees in Uganda and a refugee Issues paper for the NDP III</a>
              </h2>

              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="icofont-user"></i> PADRI staff joined other researchers from ACE Policy Research Institute</li>
                  <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <time datetime="2020-01-01">March – November, 2019</time></li>
                  <li class="d-flex align-items-center"><i class="icofont-comment"></i>12 refugee hosting districts, Uganda</li>
                </ul>
              </div>
          ...
          <div class="col-lg-4">
            ...
            <h3 class="sidebar-title">All Projects</h3>
              <div class="sidebar-item tags">
                <ul>
                  <li><a href="projects.php">Most Recent</a></li><br>
                  <li><a href="all-2014-2016-projects.php">2014 - 2016</a></li><br>
                  <li><a href="all-2011-2013-projects.php">2011 - 2013</a></li><br>
                </ul>
